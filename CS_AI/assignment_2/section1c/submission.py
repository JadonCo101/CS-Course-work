...
class CustomPlayer:
    ...
    def move(self, game, time_left, search_depth=4):
        ...
        best_move, utility = alphabeta(self, game, time_left, depth=search_depth)
...
def maxVals(player, game, my_turn, depth, alpha, beta, time_left):
    if((not game.get_active_moves()) or depth == 0 or time_left() <= 100):
        return (None, (player.utility(game, my_turn)))
    v = float('-inf')
    for element in (game.get_active_moves()):
        pMove = (game.forecast_move(element))
