    ...
    def update(self, model):
        ...
        for idx, m in enumerate(model.modules):
            if hasattr(m, 'weight'):
                ...
                v_prev = self.grad_tracker[idx]['dw']
                self.grad_tracker[idx]['dw'] = (self.momentum * v_prev) - (self.learning_rate * (m.dw))
            ...
            if hasattr(m, 'bias'):
                ...
                #############################################################################
                v_prev = self.grad_tracker[idx]['db']
                self.grad_tracker[idx]['db'] = (self.momentum * v_prev) - (self.learning_rate * m.db)
