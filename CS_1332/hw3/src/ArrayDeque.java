...
public class ArrayDeque<T> {
    ...
    public void addFirst(T data) {
        if (data == null) {
            throw new IllegalArgumentException("The data attempting to be inputted to the front of the deque is null");
        } else if (backingArray[front] == null & size == 0) {
    ...
    public T removeFirst() {
        if (size == 0) {
            throw new NoSuchElementException("The deque is empty, so no elements can be removed from the deque");
        } else if (size == 1) {
            T data = backingArray[front];
            backingArray[front] = null;
            size = 0;
            //front = 0; this should not be done
            return data;
        } else {
            T data = backingArray[front];
            backingArray[front] = null;
    ...
    public T removeLast() {
        if (size == 0) {
            ...
            backingArray[front] = null;
            size = 0;
            //front = 0; this also should not be done
            return data;
        } else {
    ...
    public T getFirst() {
        if (size == 0) {
            throw new NoSuchElementException("The deque is empty, so there is no First element");
        }
    ...
    public T getLast() {
        if (size == 0) {
            throw new NoSuchElementException("The deque is empty, so there is no Last element");
        }
